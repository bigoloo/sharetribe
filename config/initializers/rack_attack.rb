class Rack::Attack
  ...
  ActiveSupport::Notifications.subscribe('rack.attack') do |name, start, finish, request_id, req|
    Rails.logger.info("[Rack::Attack] #{start} #{finish} #{request_id} #{req.env['rack.attack.matched']} #{req.env['rack.attack.match_discriminator']} #{req.env['rack.attack.match_type']} #{req.env['rack.attack.match_data']}")
  end
